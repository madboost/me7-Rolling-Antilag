...
function printusage()
	{
		echo "Usage: php rollingv3.php ecu.bin dump.ecu [0x_Main_Code] [0x_Variables] [0x_Counter_NLS]\n";
		echo "Example: php rollingv3.php ecu.bin dump.ecu 0x76980 0x170A0\n";
		echo "Example: php rollingv3.php ecu.bin dump.ecu\n";
...
if($argv[4] == "")
	{
		echo "Finding a good space for rolling antilag configuration variables..\r\n";
	...
	{
		echo "Using space given by argument for rolling antilag configuration variables..\r\n";
...
$reeplace = array("\xE6","\xFF","\xB0","\x36","\xFF","\xFF","\xFF","\xFF","\xFF");
...
$line1 = array("\x9A","\x2B","\x12","\x80","\xC2","\xF4","\x40","\x8E","\xD7","\x00","\x81","\x00","\xC2","\xF9","\x00","\x7E");
